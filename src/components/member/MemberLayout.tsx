...
export function MemberLayout({ children }: MemberLayoutProps) {
  ...
  const getMembershipBadge = (type: string | undefined) => {
    switch (type) {
      case 'basic':
        return { color: 'text-blue-600', label: 'Básico' };
      case 'premium':
        return { color: 'text-purple-600', label: 'Premium' };
      case 'vip':
        return { color: 'text-yellow-600', label: 'VIP' };
      default:
        return { color: 'text-blue-600', label: 'Básico' };
    }
  };
  ...
  const membershipInfo = getMembershipBadge(currentUser.membershipType);
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Portal de Miembros</p>
              </div>
            </div>
